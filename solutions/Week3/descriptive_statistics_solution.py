"""
Descriptive Statistics Lab - Solutions
"""
...
print("\nVisualization saved as 'visitors_distribution.png'")
...
print("Generating Poisson distribution...")
...
def clt_demonstration(population, sample_size=30, n_samples=1000, title=''):
    ...
    # Save the figure
    filename = f"clt_{title.lower().replace(' ', '_')}.png"
    plt.savefig(filename)
    plt.close()
    print(f"Saved: {filename}")

# 3.1 CLT with Exponential distribution
print("Demonstrating CLT with exponential distribution...")
...
print("Demonstrating CLT with uniform distribution...")
...
day_stats = tips.groupby('day')['total_bill'].describe()
print(day_stats)
...
print("\nAll exercises completed! Check the generated visualizations.")
